        ...
        ZStack{
          ...
          //  switch scoreEntryVM.currentGame.game.play_format {
            case .matchplay:
                ...
                if scoreEntryVM.currentGame.game.competitorArray[competitorIndex].competitorScoresArray[scoreEntryVM.holeIndex].shotsRecdHoleMatch != 0 {
                    Text(scoreEntryVM.currentGame.game.competitorArray[competitorIndex].competitorScoresArray[scoreEntryVM.holeIndex].shotsRecdHoleMatch.formatted())
                        .offset(x: 22, y: 18)
            ...
            case .strokeplay:
                ...
                if scoreEntryVM.currentGame.game.competitorArray[competitorIndex].competitorScoresArray[scoreEntryVM.holeIndex].shotsRecdHoleStroke != 0 {
                    Text(scoreEntryVM.currentGame.game.competitorArray[competitorIndex].competitorScoresArray[scoreEntryVM.holeIndex].shotsRecdHoleStroke.formatted())
                        .offset(x: 22, y: 18)
                        .foregroundColor(burntOrange)
                        .fontWeight(.semibold)
                }
